...
Using the average rewards we can estimate the algorithms perfomance. After simulating 10 episodes of 10,000 timesteps we have a firm grasp over if an algorithm performed well.
