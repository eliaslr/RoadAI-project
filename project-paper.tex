...
% There are two different types of agents: dump trucks and excavators. The excavators fill dump trucks
% with gravel(?), which the dump trucks then carry away to leave at the site of the unfinished road.
