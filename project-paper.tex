...
\author{
	...
	By training the agents on our custom environment we have shown that MARL algorithms can be used to solve this problem.
	There is hoverver the big caveat that reality gap between our environment and real life.
	Real construction sites aren't perfectly square and trucks aren't pixels capable of turning in every cardinal direction instantly.
	Another big caveat is the lack of a proper baseline of comparasion to our solution.
	Originally we had planned to compare our solution to the others contestants in the competion solutions, but
	as far as we can tell no solution have been offically published.
	Keeping these caveats in mind, this paper still shows the promise of MARL algorithms to show these kind of
