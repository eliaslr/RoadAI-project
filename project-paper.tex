...
% -----------------------------------
% -------------- TITLE --------------
\title{RoadAI - A Multiagent Reinforcement Learning Approach to Reducing CO2 Emissions at a Construction Site}
% -----------------------------------
...
\author{
	...
	Using the average episodic rewards we can estimate the algorithms performance.
	...
	Each algorithm was trained for 250 episiodes of a fixed length of 5000 steps.
...
%   Proposal: RoadAI - A Multiagent Reinforcement Learning approach to reducing CO2 emissions at a construction site
