...
\author{
  ...
  that with further training, this algorithm could yield better results.
	% In this paper, we have implemented multi-agent implementations of both DQN and PPO. The goal is to compare
  % the results from both of these implementations. 
